...
test("includes mobile game controls for exploration and OX play", async () => {
  ...
  assert.match(page, /const difficultyOptions/);
  assert.match(page, /저학년/);
  assert.match(page, /고학년/);
  assert.match(page, /중학생/);
  assert.match(page, /safe-school-settings/);
  assert.match(page, /role="switch"/);
  assert.match(page, /cursorGuideOn/);
  assert.match(page, /settings-modal/);
  assert.match(page, /instagram\.com\/kimju\.zip/);
  assert.match(page, /@kimju\.zip/);
  assert.match(css, /\.guide-off \.hotspot/);
  assert.match(css, /\.settings-modal/);
  assert.match(css, /\.instagram-mark/);
  assert.match(css, /\.sequence-quiz-card \.sequence-options b/);
